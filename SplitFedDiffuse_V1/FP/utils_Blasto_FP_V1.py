...
def eval(loader, local_model1,local_model2,local_model3,local_ViTmodel,reshapenet,vdenoiser1,vdenoiser2,global_dn_pred1,global_dn_pred2,loss_fn,folder):
    ...
    with torch.no_grad():
        for idx,(x, y) in enumerate(loader):
            ...
            denoised_pred1 = denoise(combined_pred1, vdenoiser1, alpha_cum, t, device)
            ...
            denoised_pred2 = denoise(combined_pred2, vdenoiser2, alpha_cum, t, device)
...
def test(loader, modelclientFE,modelserver,modelclientBE,test_ViTmodel,reshapenet,tdenoiser1,tdenoiser2,loss_fn,folder):
    ...
    with torch.no_grad():
        for idx,(x, y) in enumerate(loader):
            ...
            denoised_pred1 = denoise(combined_pred1, tdenoiser1, alpha_cum, t, device=device)
            alldenoised_pred1.append(denoised_pred1)
            ...
            denoised_pred2 = denoise(combined_pred2, tdenoiser2, alpha_cum, t, device=device)
    ...
    torch.save(alldenoised_pred1, '/lustre06/project/6008975/csj5/narvalenv/allnoisy_pred1_Blasto_V1.pth')
