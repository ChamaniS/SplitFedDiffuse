...
def test(loader, modelclientFE, modelserver, modelclientBE, test_ViTmodel, reshapenet, tdenoiser1, tdenoiser2, loss_fn,
    ...
    with torch.no_grad():
        for idx, (x, y) in enumerate(loader):
            ...
            ViT_out_noisy_resized = F.interpolate(ViT_out_resized, size=(112, 112), mode="bilinear",
                                                  align_corners=False)
            combined_pred1 = normalize_features(predictions1) + normalize_features(ViT_out_noisy_resized)
            allcombined_pred1.append(combined_pred1)
            ...
            combined_pred2 = normalize_features(predictions2) + normalize_features(ViT_out_noisy_resized)
            allcombined_pred2.append(combined_pred2)
            # Denoising model 2
    ...
    torch.save(allcombined_pred1, 'C:/Users/csj5/Projects/Attackmodel/InputFeatureCheckpoints/allnoisy_pred1_Blasto_V1.pth')
