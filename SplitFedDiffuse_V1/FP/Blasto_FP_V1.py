...
from utils_Blasto_FP_V1 import (get_loaders, eval, get_loaders_test, test)
...
output_file = "/lustre06/project/6008975/csj5/narvalenv/Saved/baseline/Fed_Avg/Outputs/output.txt"
...
dataDir = "/lustre06/project/6008975/csj5/Blastocyst_Data/non-uniform/federated/"
...
#1. Train function
def train(train_loader, local_model1,local_model2,local_model3,local_ViTmodel,reshapenet,denoiser1,denoiser2,global_dn_pred1,global_dn_pred2,optimizer1,optimizer2,optimizer3, loss_fn):
    ...
    for batch_idx, (data, targets) in enumerate(loop):
        ...
        combined_pred1 = attention_weights1 * normalize_features(predictions1) + (
                    1 - attention_weights1) * normalize_features(ViT_out_noisy_resized)
