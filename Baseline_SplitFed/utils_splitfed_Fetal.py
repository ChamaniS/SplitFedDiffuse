...
def eval(loader, modelclientFE,modelserver,modelclientBE,loss_fn,folder):
    #modelclientFE.eval()
    #modelserver.eval()
    #modelclientBE.eval()
...
def test(loader, modelclientFE,modelserver,modelclientBE,loss_fn,folder):
    ...
    torch.save(allpredictions1, 'C:/Users/csj5/Projects/Fetal_segmentation/Saved/Checkpoints/allcombined_pred1.pth')
