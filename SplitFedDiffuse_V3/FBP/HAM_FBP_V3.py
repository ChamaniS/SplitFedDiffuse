...
from utils_HAM_FBP_V3 import (get_loaders, eval, get_loaders_test, test)
...
output_file = "/lustre06/project/6008975/csj5/narvalenv/output_FBP_V3.txt"
sys.stdout = open(output_file, "w")

DataF = "/lustre06/project/6008975/csj5/HAM10K/HAM_uniform_federated_new/"
save_F = "/lustre06/project/6008975/csj5/narvalenv/Saved4/baseline/Fed_Avg/"
...
def train(train_loader, local_model1,local_model2,local_model3,denoiser1,denoiser2,denoiser3,denoiser4,global_dn_pred1,global_dn_pred2, optimizer1,optimizer2,optimizer3, loss_fn):
    ...
    for batch_idx, (data, targets) in enumerate(loop):
        ...
        # Denoising model 1
        denoised_pred1 = denoise(normalize_features(noisy_pred1), denoiser1, alpha_cum, t, device)
        ...
        # Denoising model 2
        denoised_pred2 = denoise(normalize_features(noisy_pred2), denoiser2, alpha_cum, t, device)
        ...
        kl_weight = 0.00001
        recon_weight =  0.25                     
        loss = seg_loss + recon_weight*(recon_loss2 + recon_loss1 +recon_loss4 +recon_loss3) 
            ...
            for epoch in range(args.local_ep):
                ...
                if cl_idx == 1:
                    ...
                    if least_lossC1 > val_epoch_loss:
                        ...
                        torch.save(local_denoiser3.state_dict(),save_F + './Checkpoints/C1_denoiser3.pth')
                        torch.save(local_denoiser4.state_dict(),save_F + './Checkpoints/C1_denoiser4.pth')
                ...
                if cl_idx == 2:
                    ...
                    if least_lossC2 > val_epoch_loss:
                        ...
                        torch.save(local_denoiser3.state_dict(),save_F + './Checkpoints/C2_denoiser3.pth')
                        torch.save(local_denoiser4.state_dict(),save_F + './Checkpoints/C2_denoiser4.pth')                                           
                ...
                if cl_idx == 3:
                    ...
                    if least_lossC3 > val_epoch_loss:
                        ...
                        torch.save(local_denoiser3.state_dict(),save_F + './Checkpoints/C3_denoiser3.pth')
                        torch.save(local_denoiser4.state_dict(),save_F + './Checkpoints/C3_denoiser4.pth')                                             
                ...
                if cl_idx == 4:
                    ...
                    if least_lossC4 > val_epoch_loss:
                        ...
                        torch.save(local_denoiser3.state_dict(),save_F + './Checkpoints/C4_denoiser3.pth')
                        torch.save(local_denoiser4.state_dict(),save_F + './Checkpoints/C4_denoiser4.pth')                                           
                ...
                if cl_idx == 5:
                    ...
                    if least_lossC5 > val_epoch_loss:
                        ...
                        torch.save(local_denoiser3.state_dict(),save_F + './Checkpoints/C5_denoiser3.pth')
                        torch.save(local_denoiser4.state_dict(),save_F + './Checkpoints/C5_denoiser4.pth')                       
