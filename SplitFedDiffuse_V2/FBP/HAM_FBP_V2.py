...
from utils_HAM_FBP_V2 import (get_loaders, eval, get_loaders_test, test)
...
output_file = "/lustre06/project/6008975/csj5/narvalenv/output_FBP_V2.txt"
sys.stdout = open(output_file, "w")

DataF = "/lustre06/project/6008975/csj5/HAM10K/HAM_uniform_federated_new/"
save_F = "/lustre06/project/6008975/csj5/narvalenv/Saved3/baseline/Fed_Avg/"

TRAIN_IMG_DIR_C1 = DataF+"./client_1/train_img/"
TRAIN_MASK_DIR_C1 = DataF+"./client_1/train_mask/"
VAL_IMG_DIR_C1 = DataF+"./client_1/test_img/"
VAL_MASK_DIR_C1 = DataF+"./client_1/test_mask/"

#client 2
TRAIN_IMG_DIR_C2 = DataF+"./client_2/train_img/"
TRAIN_MASK_DIR_C2 = DataF+"./client_2/train_mask/"
VAL_IMG_DIR_C2 = DataF+"./client_2/test_img/"
VAL_MASK_DIR_C2 = DataF+"./client_2/test_mask/"

#client 3
TRAIN_IMG_DIR_C3 = DataF+"./client_3/train_img/"
TRAIN_MASK_DIR_C3 = DataF+"./client_3/train_mask/"
VAL_IMG_DIR_C3 = DataF+"./client_3/test_img/"
VAL_MASK_DIR_C3 = DataF+"./client_3/test_mask/"

#client 4
TRAIN_IMG_DIR_C4 = DataF+"./client_4/train_img/"
TRAIN_MASK_DIR_C4 = DataF+"./client_4/train_mask/"
VAL_IMG_DIR_C4 = DataF+"./client_4/test_img/"
VAL_MASK_DIR_C4 = DataF+"./client_4/test_mask/"

#client 5
TRAIN_IMG_DIR_C5 = DataF+"./client_5/train_img/"
TRAIN_MASK_DIR_C5 = DataF+"./client_5/train_mask/"
VAL_IMG_DIR_C5 = DataF+"./client_5/test_img/"
VAL_MASK_DIR_C5 = DataF+"./client_5/test_mask/"
...
#1. Train function
def train(train_loader, local_model1,local_model2,local_model3,denoiser1,denoiser2,denoiser3,denoiser4,global_dn_pred1,global_dn_pred2, optimizer1,optimizer2,optimizer3, loss_fn):
    ...
    for batch_idx, (data, targets) in enumerate(loop):
        ...
        #all_predictions1_noisy.append(noisy_pred1.detach().cpu())
...
def main():
    ...
    #global_ViTmodel = vit_b_16().to(device)
    ...
    test_epoch_loss, test_epoch_seg_loss,test_epoch_recon1_loss,test_epoch_recon2_loss,test_epoch_acc, test_epoch_accwithback,test_epoch_accnoback,global_dn_pred1,global_dn_pred2 = test(test_loader, global_model1_fed, global_model2_fed, global_model3_fed,global_denoiser1,global_denoiser2, loss_fn, test_folder)
    ...
    for com_round in (range(args.rounds)):
            ...
            for epoch in range(args.local_ep):
                ...
                if cl_idx == 1:
                    ...
                    val_epoch_loss, val_epoch_acc, valepoch_iou_withbackground, valepoch_iou_nobackground, valepoch_iou_class0, valepoch_iou_class1 = eval(
                        val_loader, local_model1 , local_model2, local_model3, local_denoiser1,local_denoiser2,global_dn_pred1,global_dn_pred2,loss_fn, folder)
                    ...
                    if least_lossC1 > val_epoch_loss:
                        ...
                        torch.save(local_model1.state_dict(),'./Saved3/baseline/Fed_Avg/Checkpoints/C1M1_localcheckpoint.pth')
                        torch.save(local_model2.state_dict(),'./Saved3/baseline/Fed_Avg/Checkpoints/C1M2_localcheckpoint.pth')
                        torch.save(local_model3.state_dict(),'./Saved3/baseline/Fed_Avg/Checkpoints/C1M3_localcheckpoint.pth')
                        torch.save(local_denoiser1.state_dict(),'./Saved3/baseline/Fed_Avg/Checkpoints/C1_denoiser1.pth')
                        torch.save(local_denoiser2.state_dict(),'./Saved3/baseline/Fed_Avg/Checkpoints/C1_denoiser2.pth')
                        torch.save(local_denoiser3.state_dict(),'./Saved3/baseline/Fed_Avg/Checkpoints/C1_denoiser3.pth')
                        torch.save(local_denoiser4.state_dict(),'./Saved3/baseline/Fed_Avg/Checkpoints/C1_denoiser4.pth')
                ...
                if cl_idx == 2:
                    ...
                    if least_lossC2 > val_epoch_loss:
                        ...
                        torch.save(local_model1.state_dict(),'./Saved3/baseline/Fed_Avg/Checkpoints/C2M1_localcheckpoint.pth')
                        torch.save(local_model2.state_dict(),'./Saved3/baseline/Fed_Avg/Checkpoints/C2M2_localcheckpoint.pth')
                        torch.save(local_model3.state_dict(),'./Saved3/baseline/Fed_Avg/Checkpoints/C2M3_localcheckpoint.pth')
                        torch.save(local_denoiser1.state_dict(),'./Saved3/baseline/Fed_Avg/Checkpoints/C2_denoiser1.pth')
                        torch.save(local_denoiser2.state_dict(),'./Saved3/baseline/Fed_Avg/Checkpoints/C2_denoiser2.pth')
                        torch.save(local_denoiser3.state_dict(),'./Saved3/baseline/Fed_Avg/Checkpoints/C2_denoiser3.pth')
                        torch.save(local_denoiser4.state_dict(),'./Saved3/baseline/Fed_Avg/Checkpoints/C2_denoiser4.pth')                                                
                ...
                if cl_idx == 3:
                    ...
                    if least_lossC3 > val_epoch_loss:
                        ...
                        torch.save(local_model1.state_dict(),'./Saved3/baseline/Fed_Avg/Checkpoints/C3M1_localcheckpoint.pth')
                        torch.save(local_model2.state_dict(),'./Saved3/baseline/Fed_Avg/Checkpoints/C3M2_localcheckpoint.pth')
                        torch.save(local_model3.state_dict(),'./Saved3/baseline/Fed_Avg/Checkpoints/C3M3_localcheckpoint.pth')
                        torch.save(local_denoiser1.state_dict(),'./Saved3/baseline/Fed_Avg/Checkpoints/C3_denoiser1.pth')
                        torch.save(local_denoiser2.state_dict(),'./Saved3/baseline/Fed_Avg/Checkpoints/C3_denoiser2.pth')  
                        torch.save(local_denoiser3.state_dict(),'./Saved3/baseline/Fed_Avg/Checkpoints/C3_denoiser3.pth')
                        torch.save(local_denoiser4.state_dict(),'./Saved3/baseline/Fed_Avg/Checkpoints/C3_denoiser4.pth')                                              
                ...
                if cl_idx == 4:
                    ...
                    if least_lossC4 > val_epoch_loss:
                        ...
                        torch.save(local_model1.state_dict(),'./Saved3/baseline/Fed_Avg/Checkpoints/C4M1_localcheckpoint.pth')
                        torch.save(local_model2.state_dict(),'./Saved3/baseline/Fed_Avg/Checkpoints/C4M2_localcheckpoint.pth')
                        torch.save(local_model3.state_dict(),'./Saved3/baseline/Fed_Avg/Checkpoints/C4M3_localcheckpoint.pth')
                        torch.save(local_denoiser1.state_dict(),'./Saved3/baseline/Fed_Avg/Checkpoints/C4_denoiser1.pth')
                        torch.save(local_denoiser2.state_dict(),'./Saved3/baseline/Fed_Avg/Checkpoints/C4_denoiser2.pth')
                        torch.save(local_denoiser3.state_dict(),'./Saved3/baseline/Fed_Avg/Checkpoints/C4_denoiser3.pth')
                        torch.save(local_denoiser4.state_dict(),'./Saved3/baseline/Fed_Avg/Checkpoints/C4_denoiser4.pth')                                             
                ...
                if cl_idx == 5:
                    ...
                    if least_lossC5 > val_epoch_loss:
                        ...
                        torch.save(local_model1.state_dict(),'./Saved3/baseline/Fed_Avg/Checkpoints/C5M1_localcheckpoint.pth')
                        torch.save(local_model2.state_dict(),'./Saved3/baseline/Fed_Avg/Checkpoints/C5M2_localcheckpoint.pth')
                        torch.save(local_model3.state_dict(),'./Saved3/baseline/Fed_Avg/Checkpoints/C5M3_localcheckpoint.pth')
                        torch.save(local_denoiser1.state_dict(),'./Saved3/baseline/Fed_Avg/Checkpoints/C5_denoiser1.pth')
                        torch.save(local_denoiser2.state_dict(),'./Saved3/baseline/Fed_Avg/Checkpoints/C5_denoiser2.pth')
                        torch.save(local_denoiser3.state_dict(),'./Saved3/baseline/Fed_Avg/Checkpoints/C5_denoiser3.pth')
                        torch.save(local_denoiser4.state_dict(),'./Saved3/baseline/Fed_Avg/Checkpoints/C5_denoiser4.pth')                        
            ...
            for epoch in range(args.val_global_ep):
                ...
                if cl_idx == 1:
                    g_val_epoch_loss, g_val_epoch_acc, g_val_epoch_iouwithback, g_val_epoch_iounoback, g_valepoch_iou_class0, g_valepoch_iou_class1 = eval(
                        val_loader, global_model1_fed, global_model2_fed, global_model3_fed,global_denoiser1,global_denoiser2, global_dn_pred1,global_dn_pred2,loss_fn, folder)
        ...
        tot_gloss = client1_g_val_loss[-1] + client2_g_val_loss[-1] + client3_g_val_loss[-1] + client4_g_val_loss[-1] + client5_g_val_loss[-1]
...
# ------------------------------------------TESTING USING THE GLOBAL MODEL-----------------------------------------------------------------------
        ...
        for epoch in range(args.val_global_ep):
            ...
            test_epoch_loss, test_epoch_seg_loss,test_epoch_recon1_loss,test_epoch_recon2_loss, test_epoch_acc, test_epoch_accwithback,test_epoch_accnoback,global_dn_pred1,global_dn_pred2 = test(test_loader,  M1_test, M2_test, M3_test,test_denoiser1,test_denoiser2, loss_fn, test_folder)
            print('\n')
