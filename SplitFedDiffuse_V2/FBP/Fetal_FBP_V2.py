...
from utils_FBP_V2 import (get_loaders, eval, get_loaders_test, test)
...
def train(train_loader, local_model1, local_model2, local_model3, denoiser1, denoiser2, denoiser3, denoiser4, global_dn_pred1,
            ...
            for epoch in range(args.local_ep):
                ...
                if cl_idx == 1:
                    ...
                    val_epoch_loss, val_epoch_acc, valepoch_iou_withbackground, valepoch_iou_nobackground, valepoch_iou_class0, valepoch_iou_class1,valepoch_iou_class2 = eval(
                        val_loader, local_model1 , local_model2, local_model3, local_denoiser1,local_denoiser2, global_dn_pred1,global_dn_pred2,loss_fn)
            ...
            for epoch in range(args.val_global_ep):
                ...
                if cl_idx == 1:
                    g_val_epoch_loss, g_val_epoch_acc, g_val_epoch_iouwithback, g_val_epoch_iounoback, g_valepoch_iou_class0, g_valepoch_iou_class1,g_valepoch_iou_class2 = eval(
                        val_loader, global_model1_fed, global_model2_fed, global_model3_fed,global_denoiser1,global_denoiser2, global_dn_pred1,global_dn_pred2,loss_fn)
